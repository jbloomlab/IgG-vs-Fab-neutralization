...
def _(mo):
    ...
    ### Simple schematic illustrating principle of model
    The schematic below illustrates the principle of the model (this schematic was generated with BioRender):
    """
    )
    return
...
@app.cell(hide_code=True)
def _(mo):
    mo.image("biorender/IgG-vs-Fab neutralization.png", width="100%")
    return
